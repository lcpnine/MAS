...
build_and_run() {
  ...
  "$JAVA" -cp "Tileworld/bin${CP_SEP}lib/MASON_14.jar" tileworld.BaselineTileworldMain | tee "$log_file"
...
set_config1
build_and_run "baseline-config1"

set_config2
build_and_run "baseline-config2"
